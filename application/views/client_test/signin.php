                    ...
                    <div class="panel-body">
                        <form action="#" method="post" role="form">
                            <fieldset>
                                ...
                                <input type="submit" name="submit" class="btn btn-lg btn-success btn-block" value="<?php echo $this->lang->line('app_form_btn_signin')?>" />
                            </fieldset>
                            
                        </form>
                    </div>
                    <div class="panel-footer">
                        <li><a href="<?php echo  site_url('client/test_api/signup') ?>" ><?php echo  $this->lang->line('app_form_text_create_account') ?></a></li>
                    </div>
                </div>
            </div>
        </div>