                    ...
                    <div class="panel-body">
                        <form action="#" method="post" role="form">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <input class="form-control" placeholder="<?php echo 'Name' ?>" name="name" type="text" autofocus>
                                </div>
                                <div class="form-group">
                                ...
                                <input type="submit" name="submit" class="btn btn-lg btn-success btn-block" value="<?php echo $this->lang->line('app_form_btn_signup')?>" />
                            </fieldset>
                        </form>
